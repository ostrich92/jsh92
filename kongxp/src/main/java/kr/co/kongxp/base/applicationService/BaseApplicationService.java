...
public interface BaseApplicationService {
	...
	public EmpTO loginEmployee(String companyCode,String workplaceCode,String empCode, String userPw) throws FileNotFoundException
			,DataNotInputException,IdNotFoundException,PwMissMatchException;
