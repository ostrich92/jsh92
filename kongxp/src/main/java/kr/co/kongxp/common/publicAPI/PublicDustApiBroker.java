package kr.co.kongxp.common.publicAPI;
...
public class PublicDustApiBroker {
	...
	public List<DustStatusTO> requsetDustGrade() throws Exception {
		StringBuilder urlBuilder = new StringBuilder(
				"http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty"); /*
																														 * URL
																														 */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=RP8kVvmFfEYeZjhviv0XJFoT%2FetbETeo86UCAizv0nEXiXJRFi%2BBgA1twWTverd5QKqgQsn1Waa%2F0QPDoBnG2Q%3D%3D"); /*
																														 * Service
																														 * Key
																														 */
		...
		urlBuilder.append("&" + URLEncoder.encode("sidoName", "UTF-8") + "=" + URLEncoder.encode("경남",
		...
		urlBuilder.append(
				"&" + URLEncoder.encode("ver", "UTF-8") + "=" + URLEncoder.encode("1.3", "UTF-8")); /* 오퍼레이션 버전 */
